<template>
  <div class="wrapper">
    ...
    <div class="profile">
      ...
      <img
        :src="
          'http://576e122.e2.mars-hosting.com/api/plan-vezbanja/workout-pictures/' +
          this.user.usr_id
        "
        alt="profile"
        id="pic"
  ...
  methods: {
    ...
    async getUserData() {
      ...
      try {
        ...
        this.goal = res.data.wkData.subcat_name;
    ...
    async editWorkout() {
      ...
      try {
        const res = await axios.post(
          "http://576e122.e2.mars-hosting.com/api/plan-vezbanja/workout-editPlan",
          params
        );
      } catch (eror) {
        console.log(eror);
